...
if(!useNativeScroll) {
    ...
    vertexPosition.x += sin(((vertexPosition.x * vertexPosition.y + 1.0) / 2.0) * 3.141592) * (sin(uPlaneDeformation / 100.0))/1.8;
    vertexPosition.x += sin(((vertexPosition.y * vertexPosition.x + 5.0) / 2.0) * 3.141592) * (sin(uPlaneDeformation / 100.0))/1.3;
    ...
    void main() {
        ...
        vec2 redTextCoords = vec2(vTextureCoord.xy  + uScrollEffect / 700.0);
        vec2 greenTextCoords = vec2(vTextureCoord.xy + uScrollEffect / 6000.0);
        vec2 blueTextCoords = vec2(vTextureCoord.xy+ uScrollEffect / 6000.0);
